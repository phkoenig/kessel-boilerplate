#!/usr/bin/env tsx
/**
 * Build-Script: Generiert src/config/version.ts mit App-Version, Commit-SHA,
 * Environment und einem Build-Zeitstempel.
 *
...
/**
 * Erzeugt einen ISO-Zeitstempel fuer die Build-Metadaten.
 *
 * @returns ISO-Zeitstempel des aktuellen Generierungslaufs.
 */
...
function main(): void {
  ...
  // 4. Weitere Build-Metadaten bestimmen
  const generatedAt = getGeneratedAt()

  // 5. TypeScript-Datei generieren
...
export const APP_BUILD_GENERATED_AT = "${generatedAt}" as const
`

  // 6. Verzeichnis erstellen falls nicht vorhanden
  ...
  process.stdout.write(`  APP_BUILD_COMMIT: ${commitSha}\n`)
  process.stdout.write(`  APP_ENV: ${env}\n`)
  process.stdout.write(`  APP_BUILD_GENERATED_AT: ${generatedAt}\n`)
}
