...
/**
 * Detail-Seite für den Standard+Filter-Archetyp.
 */
export default function StandardFilterLayoutPage(): React.ReactElement {
  const archetype = getArchetype("standard-filter")
