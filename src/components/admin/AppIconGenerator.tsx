...
export function AppIconGenerator(): React.ReactElement {
  ...
  const {
    ...
    appDescription: brandingDescription,
  ...
  useEffect(() => {
    if (!appName && brandingAppName) {
      setAppName(brandingAppName)
    }
    if (!description && brandingDescription) {
      setDescription(brandingDescription)
    }
    if (!currentIconUrl && brandingIconUrl) {
      setCurrentIconUrl(brandingIconUrl)
    }
  }, [appName, brandingAppName, brandingDescription, brandingIconUrl, currentIconUrl, description])
